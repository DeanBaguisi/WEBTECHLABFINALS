      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
         ...
         <div class="row">
                ...
                <div class="col-lg-3 col-sm-12 ">
                    <button class="btn btn-lg btn-secondary m-2" onClick="byPriceExpe()"> Expensive </button>
                    <script type="text/javascript">
                ...
                <div class="col-lg-3 col-sm-12 ">
                    <button class="btn btn-lg btn-secondary m-2" onclick="byAvailability()"> Available </button>
                    <script type="text/javascript">
