  ...
  <link rel="stylesheet" href="css/style.css"> </head>
     ...
     <sql:setDataSource driver="com.mysql.jdbc.Driver"
        ...
        <sql:query var="result">
               SELECT * FROM house WHERE current_rental_fee BETWEEN CAST(? AS DECIMAL(15,0)) AND CAST(? AS DECIMAL(15,0)) Order by current_rental_fee;     
                
                <sql:param value="${param.minPrice}" />
                <sql:param value="${param.maxPrice}" />
        </sql:query>
